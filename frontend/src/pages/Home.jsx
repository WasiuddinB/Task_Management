...
const Home = () => {
  ...
  return (
    <>
      <MainLayout>
        {!isLoggedIn ? (
          <div className='bg-slate-600 text-white h-[40vh] py-8 text-center'>
            <h1 className='text-2xl'> Wasi Uddin welcomes you.</h1>
            <Link to="/signup" className='mt-10 text-xl block space-x-2 hover:space-x-4'>
              <span className='transition-[margin]'>Manage all of your tasks here.</span>
